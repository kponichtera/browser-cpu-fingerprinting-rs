...
use js_sys::{Array, Atomics, BigInt64Array, BigUint64Array, SharedArrayBuffer};
use wasm_bindgen::JsValue;
use wasm_bindgen::prelude::*;
use web_sys::{Blob, BlobPropertyBag, MessageEvent, Url, Worker};
use web_sys::console::info;

pub fn start_clock_worker() -> Result<(Worker, BigInt64Array), JsValue> {
    // let origin = window()
    ...
    let buffer_data = BigInt64Array::new(&shared_buffer);
    Atomics::store_bigint(&buffer_data, 0, 0)?;
