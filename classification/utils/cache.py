...
def model_filter(db_models):
    ...
    db_models = list(
        map(lambda x: 'AMD A9-9425' if x == 'AMD A9-9425 Radeon R5, Compute Cores 2C+3G' else x, db_models))
    ...
    db_models = list(
        map(lambda x: 'Intel(R) Core(TM) i7-7500U' if x == 'Intel(R) core (TM) i7-7500U' else x, db_models))
    ...
    db_models = list(map(lambda x: 'AMD FX(TM)-8320E' if x == 'AMD FX 8320E' else x, db_models))
    db_models = list(
        map(lambda x: 'Intel(R) Core(TM) i5-8265U' if x == 'Intel(R) Core(TM) i5-8265UCPU' else x, db_models))
    ...
    db_models = list(
        map(lambda x: 'Intel(R) Celeron(R) N4000' if x == 'Intel(R) Celeron(R) N4000 CPU' else x, db_models))
    ...
    db_models = list(
        map(lambda x: 'Intel(R) Core(TM) i5-10210U' if x == 'Intel(R) Core(TM) i5-1021OU' else x, db_models))
    ...
    db_models = list(
        map(lambda x: 'AMD FX-7500' if x == 'AMD FX-7500 Radeon R7, 10 Compute Cores 4C+6G' else x, db_models))
    db_models = list(
    ...
    db_models = list(
        map(lambda x: 'AMD A9-9420' if x == 'AMD A9-9420 RADEON R5, 5 COMPUTE CORES 2C+3G' else x, db_models))
    ...
    db_models = list(
        map(lambda x: 'Intel(R) Core(TM) i7-9750H' if x == 'Intel(R) Core(TM) i7- 9750HCPU' else x, db_models))
    ...
    db_models = list(
        map(lambda x: 'Intel(R) Core(TM) i7-7700HQ' if x == 'Intel(R) Core(I) I7-7700HQ' else x, db_models))
