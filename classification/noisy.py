...
X_l2, y_l2large = prepare_l2(balance, db_models, benchmarks['cachesize_benchmarks_small'],
                             benchmarks['cachesize_benchmarks_large'], csv_dict['name'], csv_dict['rname'],
                             csv_dict['l2'])
...
X_tlb, y_tlb = prepare_tlb(balance, db_models, benchmarks['tlb_benchmarks'], csv_dict['name'], csv_dict['rname'],
                           csv_dict['tlb'])
X_threads, y_threads = prepare_threads(balance, db_models, benchmarks['cores'], csv_dict['name'], csv_dict['rname'],
                                       csv_dict['threads'])
X_htt, y_htt = prepare_htt(balance, db_models, benchmarks['cores'], csv_dict['name'], csv_dict['rname'],
                           csv_dict['smt'])
X_smt, y_smt = prepare_smt(balance, db_models, benchmarks['cores'], csv_dict['name'], csv_dict['rname'],
                           csv_dict['smt'])
X_boosttech, y_boosttech = prepare_boosttech(balance, db_models, benchmarks['singleperf_benchmarks'], csv_dict['name'],
                                             csv_dict['rname'], csv_dict['base'], csv_dict['boost'])
X_uarch, y_uarch = prepare_uarch(balance, db_models, benchmarks['cachesize_benchmarks_small'],
                                 benchmarks['cachesize_benchmarks_large'], benchmarks['tlb_benchmarks'],
                                 benchmarks['cacheasso_benchmarks'], benchmarks['cores'], csv_dict['name'],
                                 csv_dict['rname'], csv_dict['uarch'])
X_uarch_grouped, y_uarch_grouped = prepare_uarch_grouped(balance, db_models, benchmarks['cachesize_benchmarks_small'],
                                                         benchmarks['cachesize_benchmarks_large'],
                                                         benchmarks['tlb_benchmarks'],
                                                         benchmarks['cacheasso_benchmarks'], benchmarks['cores'],
                                                         csv_dict['name'], csv_dict['rname'], csv_dict['uarch'])
...
X_othermodel, y_othermodel = prepare_othermodel(balance, db_models, benchmarks['singleperf_benchmarks'],
                                                benchmarks['cores'], csv_dict['name'], csv_dict['rname'])
X_othermodel_execution, y_othermodel_execution = prepare_model_execution(balance, db_models,
                                                                         benchmarks['execution_times'],
                                                                         benchmarks['cachesize_benchmarks_large'],
                                                                         csv_dict['name'], csv_dict['rname'])
X_othermodel_timer, y_othermodel_timer = prepare_model_timer(balance, db_models, benchmarks['timer'], csv_dict['name'],
                                                             csv_dict['rname'])
X_m1, y_m1 = prepare_M1(False, db_models, benchmarks['cachesize_benchmarks_small'],
                        benchmarks['cachesize_benchmarks_large'], benchmarks['tlb_benchmarks'],
                        benchmarks['cacheasso_benchmarks'], benchmarks['cores'], csv_dict['name'], csv_dict['rname'])
X_singleintel, y_singleintel = prepare_singleintel(False, db_models, benchmarks['execution_times'], csv_dict['name'],
                                                   csv_dict['rname'])
...
X_intelvintel_execution, y_intelvintel_execution = prepare_cpuvscpu_execution(False, 'Intel(R) Core(TM) i5-8250U',
                                                                              'Intel(R) Core(TM) i7-8550U', db_models,
                                                                              benchmarks['execution_times'],
                                                                              csv_dict['name'], csv_dict['rname'])
...
X_l1_test, y_l1_test = prepare_l1(False, db_models_test, cachesize_benchmarks_small, csv_dict['name'],
                                  csv_dict['rname'], csv_dict['l1'])
X_l2_test, y_l2large_test = prepare_l2(False, db_models_test, cachesize_benchmarks_small, cachesize_benchmarks_large,
                                       csv_dict['name'], csv_dict['rname'], csv_dict['l2'])
X_l3_test, y_l3_test = prepare_l3(False, db_models_test, cachesize_benchmarks_small, cachesize_benchmarks_large,
                                  csv_dict['name'], csv_dict['rname'], csv_dict['l3'])
X_l1asso_test, y_l1asso_test = prepare_l1asso(False, db_models_test, cacheasso_benchmarks, csv_dict['name'],
                                              csv_dict['rname'], csv_dict['l1asso'])
X_tlb_test, y_tlb_test = prepare_tlb(False, db_models_test, tlb_benchmarks, csv_dict['name'], csv_dict['rname'],
                                     csv_dict['tlb'])
X_threads_test, y_threads_test = prepare_threads(False, db_models_test, cores, csv_dict['name'], csv_dict['rname'],
                                                 csv_dict['threads'])
...
X_boosttech_test, y_boosttech_test = prepare_boosttech(False, db_models_test, singleperf_benchmarks, csv_dict['name'],
                                                       csv_dict['rname'], csv_dict['base'], csv_dict['boost'])
X_uarch_test, y_uarch_test = prepare_uarch(False, db_models_test, cachesize_benchmarks_small,
                                           cachesize_benchmarks_large, tlb_benchmarks, cacheasso_benchmarks, cores,
                                           csv_dict['name'], csv_dict['rname'], csv_dict['uarch'])
X_uarch_grouped_test, y_uarch_grouped_test = prepare_uarch_grouped(False, db_models_test, cachesize_benchmarks_small,
                                                                   cachesize_benchmarks_large, tlb_benchmarks,
                                                                   cacheasso_benchmarks, cores, csv_dict['name'],
                                                                   csv_dict['rname'], csv_dict['uarch'])
X_vendor_test, y_vendor_test = prepare_vendor(True, db_models_test, cachesize_benchmarks_small,
                                              cachesize_benchmarks_large, tlb_benchmarks, csv_dict['name'],
                                              csv_dict['rname'])
X_model_all_test, y_model_all_test = prepare_model_all(False, db_models_test, cachesize_benchmarks_small,
                                                       cachesize_benchmarks_large, tlb_benchmarks, cacheasso_benchmarks,
                                                       cores, execution_times, csv_dict['name'], csv_dict['rname'])
X_m1_test, y_m1_test = prepare_M1(False, db_models_test, cachesize_benchmarks_small, cachesize_benchmarks_large,
                                  tlb_benchmarks, cacheasso_benchmarks, cores, csv_dict['name'], csv_dict['rname'])
...
iterate_classifiers(classifiers, 'Boost Technology Availability', X_boosttech, y_boosttech, X_boosttech_test,
                    y_boosttech_test)
